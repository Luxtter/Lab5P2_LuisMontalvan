 ...
 * @author luism
 */
public class MortalKombat extends Personaje{

    public MortalKombat() {
        super();
    }

    public MortalKombat(String nombre, String universo, String fuerza, String poder, String aMental, String aFisica, String hp) {
